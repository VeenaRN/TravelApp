...
//	    @PostMapping("/fetchFare")
//	    public ModelAndView fetchFare(@RequestParam String fromloc, @RequestParam String toloc) {
//	        int fare = cs.findFareByFromLocationAndToLocation(fromloc, toloc);
//	        ModelAndView modelAndView = new ModelAndView("addBookCab.jsp"); // Replace "yourJspPageName" with the actual name of your JSP page
