...
<div class="row">
    <div class="container">
        ...
        <hr>
        <div class=" text-left">
            <a href="<%=request.getContextPath()%>/newuser" class="btn btn-success">Add Participant</a>
        </div>
        <br>
            ...
            <tbody>
                <c:forEach var="user" items="${listUser}">
                    <tr>
                        ...
                        <td><c:out value="${user.batchname}" /></td>
                        <td><c:out value="${user.address}" /></td>
                        <td>
                            <a href="edituser?participant_id=<c:out value='${user.participant_id}'/>" class="btn btn-edit">Edit</a>
                            <a href="deleteuser?participant_id=${user.participant_id}" class="btn btn-delete">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
