...
<head>
    ...
    <style>
        ...
        .btn-edit, .btn-delete {
            background-color: #cdd9e3; /* Lighter grey color */
            border-color: #6c757d;
            color: #fff; /* White text color */
        }

        .btn-edit  {
            background-color: #8cb7ef; /* Lighter blue color */
            border-color: #495057;
        }
        
        .btn-delete {
            background-color: #dc968e; /* Lighter red color */
            border-color: #495057;
        }
    </style>
</head>
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark" style="background-color: #007bff;">
            <div>
                <a href="#" class="navbar-brand">Participant Management Application</a>
            </div>
    ...
    <div class="row">
        <div class="container">
            ...
            <hr>
            <div class=" text-left">
                <a href="<%=request.getContextPath()%>/new1" class="btn btn-success">Add Batch</a>
            </div>
            <br>
                ...
                <tbody>
                    <c:forEach var="batch" items="${listBatch}">
                        <tr>
                            ...
                            <td>
                                <a href="edit1?id=<c:out value='${batch.id}'/>" class="btn btn-edit">Edit</a>
                                <a href="delete?id=${batch.id}" class="btn btn-delete">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
